...
>
  <div class="p-6 border-b border-slate-100">
    <h3 class="text-lg font-black text-slate-900">Billing statement</h3>
    <p class="text-sm text-slate-500 mt-1">Fill in customer details and select a payment type.</p>
  </div>

  <div class="p-6 space-y-6">
    <!-- Customer -->
    <div>
      <h4 class="text-sm font-black text-slate-900">Customer</h4>
      <div class="mt-3 space-y-3">
        ...
        <div>
          <label class="block text-xs font-semibold text-slate-500 uppercase mb-2">Contact number</label>
          <input
            id="cust_contact"
            type="tel"
    ...
    <!-- Payment type -->
    <div>
      <h4 class="text-sm font-black text-slate-900">Payment type</h4>
      <div class="mt-3">
        <label class="block text-xs font-semibold text-slate-500 uppercase mb-2">Select payment</label>
        <select
          id="payment_type"
          class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 outline-none focus:border-[#1e88e5] focus:ring-2 focus:ring-[#1e88e5]/20"
        >
      ...
      <div id="credit_fields" class="mt-4 hidden">
        <div class="grid grid-cols-1 gap-3">
          <div>
            <label class="block text-xs font-semibold text-slate-500 uppercase mb-2">Card number</label>
            <input
              id="card_number"
              inputmode="numeric"
          ...
          <div class="grid grid-cols-3 gap-3">
            <div class="col-span-1">
              <label class="block text-xs font-semibold text-slate-500 uppercase mb-2">Exp.</label>
              <input
                id="card_exp"
                placeholder="MM/YY"
                maxlength="5"
            ...
            <div class="col-span-1">
              <label class="block text-xs font-semibold text-slate-500 uppercase mb-2">CVC</label>
              <input
                id="card_cvc"
                inputmode="numeric"
                placeholder="123"
            ...
            <div class="col-span-1">
              <label class="block text-xs font-semibold text-slate-500 uppercase mb-2">ZIP</label>
              <input
                id="card_zip"
                inputmode="numeric"
                placeholder="1000"
      ...
      <div id="cheque_fields" class="mt-4 hidden">
        <label class="block text-xs font-semibold text-slate-500 uppercase mb-2">Cheque number</label>
        <input
          id="cheque_number"
          inputmode="numeric"
          placeholder="000000"
    ...
    <p class="text-xs text-slate-500 leading-relaxed">
      Click <span class="font-semibold text-slate-700">Next</span> to preview your booking/reservation summary.
